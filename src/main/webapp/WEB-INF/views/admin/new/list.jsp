                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                           title="Cập nhật bài viết" href='${editURL}'><i class="fa fa-edit " ></i>
                                                        </a>
...
*/
   /* $("#btnDelete").click(function () {
        var data = {};
        var ids = $('tbody input[type=checkbox]:checked').toArray()
                .map(function (currentValue, index, arrOld) {
                    console.log("arrOLD",arrOld)
                    console.log('currentValue',$(currentValue).val())
